...
combo_dev_attr_t MIPI_BT1120_ATTR =
{
  /* input mode */
  .devno = 1,
  .input_mode = INPUT_MODE_BT1120,  //使MIPI RX PHY处于CMOS模式 INPUT_MODE_CMOS
...
combo_dev_attr_t MIPI_GC2053_ATTR =
{
  /* input mode */
  .devno = 0,
  .input_mode = INPUT_MODE_MIPI,  //使MIPI RX PHY处于CMOS模式 INPUT_MODE_CMOS
  .data_rate = MIPI_DATA_RATE_X1,
...
VI_CHN_ATTR_S CHN_ATTR_GC2053_1080P = {
  {1920, 1080},
  PIXEL_FORMAT_YVU_SEMIPLANAR_420,
  DYNAMIC_RANGE_SDR8,
  VIDEO_FORMAT_LINEAR,
...
HI_U32 SAMPLE_COMM_VI_GetMipiLaneDivideMode(SAMPLE_VI_CONFIG_S* pstViConfig)
{
    ...
    if ((SONY_IMX327_2L_MIPI_2M_30FPS_12BIT == pstViConfig->astViInfo[0].stSnsInfo.enSnsType)
        ...
        || (USER_BT1120 == pstViConfig->astViInfo[0].stSnsInfo.enSnsType)
        || (GC2053_TEST == pstViConfig->astViInfo[0].stSnsInfo.enSnsType))
    {
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S* pstViDevAttr)
{
    ...
    {
        case GC2053_TEST:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_GC2053_1080P_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        case USER_BT1120:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_BT1120_720P_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        case SONY_IMX327_MIPI_2M_30FPS_12BIT:
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT:
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S* pstPipeAttr)
{
    ...
    {
        case GC2053_TEST:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_GC2053_10800P_RGB, sizeof(VI_PIPE_ATTR_S));
            break;
        case USER_BT1120:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_BT1120_720P_BIT16_420, sizeof(VI_PIPE_ATTR_S));
            break;
        case SONY_IMX327_MIPI_2M_30FPS_12BIT:
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT:
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
...
HI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S* pstChnAttr)
{
    ...
    {
        case  GC2053_TEST:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_GC2053_1080P, sizeof(VI_CHN_ATTR_S));
            break;
        case USER_BT1120:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_BT1120_720P_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
        case SONY_IMX327_MIPI_2M_30FPS_12BIT:
        case SONY_IMX327_MIPI_2M_30FPS_12BIT_WDR2TO1:
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT:
